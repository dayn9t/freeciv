...
### 覆盖率数据 (最新验证 - 2026-03-08 13:00)
| 指标 | 初始 | 当前 (含所有文件) | 当前 (排除特殊文件) | 提升 |
|------|------|------------------|--------------------|------|
| 行覆盖率 | 9.8% | 7.3% | **16.0%** | +6.2% |
| 函数覆盖率 | 21.4% | 18.0% | **31.0%** | +9.6% |
...
**新增测试文件：**
- server 模块：test_mood.c, test_setcompat.c, test_srv_signal.c, test_score.c
- aicore 模块：5 个测试文件
- common 模块增强：tile, map, city, unit, player, unittype, combat, movement, requirements, actions 等
